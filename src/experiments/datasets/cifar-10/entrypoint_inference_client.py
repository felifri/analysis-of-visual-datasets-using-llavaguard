...
base_output_dir = "/pfss/mlde/workspaces/mlde_wsp_KIServiceCenter/finngu/LlavaGuard/src/experiments/datasets/cifar-10/results/7B_25_03_26_01"
...
def main():
    ...
    logger.info("Starting image annotation: CIFAR-10...")
    ...
    try:
        for split in splits:
            ...
            iterable_ds = load_dataset("uoft-cs/cifar10", split=split).to_iterable_dataset()
