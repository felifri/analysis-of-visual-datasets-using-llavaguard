#!/bin/bash
#SBATCH --job-name=dose-annot-clip
...
# Annotate 10K generated images from text encoder ablation checkpoints with LlavaGuard
# Array mapping:
...
if [ ! -d "${GEN_DIR}/images" ]; then
    ...
    echo "Run slurm_generate_clip.sh first."
    exit 1
fi
