...
# Annotate training-seed generated images SEQUENTIALLY to avoid disk quota issues.
...
logger = logging.getLogger('annotate_trainseed')
...
"
        ...
        # Also remove individual JSONs now that parquet exists
...
echo "All training-seed annotations completed at $(date)"
