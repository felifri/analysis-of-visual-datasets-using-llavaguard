...
# Annotate 10K generated images from medium PRX-3.6B with LlavaGuard
# Array mapping:
#   0: medium_C1 (0% unsafe)
#   1: medium_C0 (original ~1.21% unsafe)

set -euo pipefail

CONDITIONS=(medium_C1 medium_C0)
...
logger = logging.getLogger('annotate_medium')
