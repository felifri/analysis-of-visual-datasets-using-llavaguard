...
# Annotate C3 (10% unsafe) generated images with LlavaGuard via SGLang

set -euo pipefail

CONDITION=C3
echo "C3 LlavaGuard annotation started on $(hostname) at $(date)"
...
echo "C3 annotation completed at $(date)"
