...
set -euo pipefail
echo "C0 training started on $(hostname) at $(date)"
...
$COMPOSER -n 8 -m prx.training.train \
    ...
    name=C0 group=dose-response image_size=512 \
