...
set -euo pipefail
echo "C1 training started on $(hostname) at $(date)"
...
$COMPOSER -n 8 -m prx.training.train \
    ...
    name=C1 group=dose-response image_size=512 \
