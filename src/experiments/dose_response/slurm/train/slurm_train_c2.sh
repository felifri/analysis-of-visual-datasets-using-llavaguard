...
set -euo pipefail
echo "C2 training started on $(hostname) at $(date)"
...
$COMPOSER -n 8 -m prx.training.train \
    ...
    name=C2 group=dose-response image_size=512 \
