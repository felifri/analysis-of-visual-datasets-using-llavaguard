...
set -euo pipefail
echo "C6 training started on $(hostname) at $(date)"
...
$COMPOSER -n 8 -m prx.training.train \
    ...
    name=C6 group=dose-response image_size=512 \
